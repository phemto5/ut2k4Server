...
RUN su -c 'wget -O linuxgsm.sh https://linuxgsm.sh && chmod +x linuxgsm.sh && bash linuxgsm.sh ut2k4server && ./ut2k4server ai && echo "SRVER-8BD3N-DG6CD-HCNAB" | ./ut2k4server cd ' ut2k4server
